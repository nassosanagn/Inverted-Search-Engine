...
Το MatchDocument χωρίζει το document σε λέξεις και κάνει lookup σε όλα τα ευρετήρια με τη λέξη αυτή. Τα αποτελέσματα των ευρετηρίων εισάγωνται στην payload_list q_result και με αυτή δημιουργείται ένα doc που έχει τα αποτελέσματα σε αύξουσα σειρά.
